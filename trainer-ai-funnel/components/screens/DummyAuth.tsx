        ...
        {!isSignedIn ? (
          <div className="space-y-4 max-w-md mx-auto w-full">
            ...
            <button
              ...
              className="w-full h-[56px] rounded-[28px] bg-white border-[3px] border-black flex items-center justify-center gap-3 hover:bg-gray-50 transition-colors"
            >
              ...
              <span className="font-semibold text-base text-black">
                {t('signInWithGoogle', state.language)}
              </span>
            </button>
            ...
            <button
              onClick={handleSignIn}
              className="w-full h-[56px] rounded-[28px] bg-black flex items-center justify-center gap-3 hover:bg-gray-800 transition-colors"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
                <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09l.01-.01zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
              </svg>
              <span className="font-semibold text-base text-white">
                {t('signInWithApple', state.language)}
              </span>
            </button>
            ...
            <div className="flex items-center gap-4 py-2">
              ...
              <span className="text-[#A5A4A4] font-semibold text-sm">
                {t('orDivider', state.language)}
              </span>
              <div className="flex-1 h-px bg-gray-200" />
            </div>
            ...
            <button
              onClick={handleSignIn}
              className="w-full h-[56px] rounded-[28px] bg-[#D4FFF4] flex items-center justify-center gap-3 hover:bg-[#c0f5e8] transition-colors"
            >
              <span className="font-semibold text-base text-black">
                Continue with Email
              </span>
